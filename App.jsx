  ...
  return (
    <div style={{ padding:"28px 24px 60px" }}>
      ...
      <div style={{ display:"flex", gap:10, marginBottom:20, flexWrap:"wrap" }}>
        ...
        {[["product",product,setProd,["ALL",...new Set(accounts.map(a=>a.product).filter(Boolean).sort())]],["status",status,setStat,["ALL","NEW","CONTACTED","PARTIAL","SETTLED"]],["district",district,setDist,districts]].map(([key,val,set,opts])=>(
